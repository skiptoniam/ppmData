...
We note that this approach is different to a targeted background 
scheme for generating ‘pseudo-absences’. If the users intent is to reduce 
sighting biases via a targetted background scheme, we recommend that bias
is accounted for via covariates (e.g. estimated bias from distance to roads)
or an offset (a known amount of effort) (e.g Warton et al., 2013;
Fithian et al, 2015).
