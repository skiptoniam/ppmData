...
Here is an example using a dataset from the `ppmData` package. We setup a quadrature scheme for the species \textit{Tasmaphena sinclairi} located within Tasmania, Australia. 
...
Here we plot the quadrature scheme. The red points represent the known locations of \textit{Tasmaphena sinclairi}. The black points represent the quadrature locations. Quasi-random quadrature where the integration points are generated using a quasi-random areal sample.
