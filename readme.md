...
tassie_preds_two <- stack(tassie_preds,p_bias_cell)
...
brks <- seq(min(p_v_lampra_w_s_cell[],na.rm = TRUE),.5,length.out=100)
arg <- list(at=seq(0,.5,.05),labels=as.character(seq(0,.5,.05)))   

par(mfrow=c(1,2),oma=c(4,4,4,4))
plot(p_v_lampra_w_s_cell,col=jet.colors(100),main='accounting for sighting bias',
  xlim=c(144.5, 148.5), ylim=c(-43.8,-40.5))#,breaks=brks,axis.args=arg)
